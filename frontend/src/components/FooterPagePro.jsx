...
export const FooterPagePro = () => {
  return (
    <div className='bg-white dark:bg-transparent z-50'>
          ...
          <div className='footer w-full lg:grid grid-cols-6 gap-x-10'>
            ...
            <div className='grid lg:grid-cols-4 grid-cols-2 gap-x-4 gap-y-5 flex-1 col-span-4'>
              <div className='flex flex-col gap-5'>
                <h4 className='font-bold text-lg text-slate-700'>Company</h4>
                <ul className='flex flex-col gap-1 font-medium text-slate-500 text-md'>
                  <li>
              ...
              <div className='flex flex-col gap-5'>
                <h4 className='font-bold text-lg text-slate-700'>Overview</h4>
                <ul className='flex flex-col gap-1 font-medium text-slate-500 text-md'>
              ...
              <div className='flex flex-col'>
                <h4 className='font-bold text-lg text-slate-700'>Subscribe</h4>
                <ul>
                  <li className='font-medium text-slate-500 text-md'>
                  ...
                  <li>
                    <input
                      ...
                      className='p-2 border border-slate-300 rounded-lg mt-2 w-full'
                    />
                  </li>
                  <li
                    id='button'
