    ...
    <Container>
      <div className='grid lg:grid-rows-none lg:grid-cols-2 gap-5 md:min-h-screen mt-[5%]'>
        <div className='flex flex-col lg:h-4/6 h-96 w-full'>
          <div className='rounded-3xl overflow-hidden h-full flex items-center justify-center bg-gray-100 dark:bg-opacity-5 cursor-pointer hover:-translate-y-3 hover:translate-x-2 transition-transform duration-150 ease-linear hover:shadow-lg'>
            <Pong />
          </div>
