      ...
      <HeroSectionContainer>
        <div className='xl:w-8/12 lg:w-full md:w-4/5 w-full lg:mb-20 md:mb-14 md:mt-32 mt-20 mb-10 relative'>
          <div className='z-40 relative'>
            <h1 className='lg:text-7xl md:text-5xl text-4xl font-black text-center bg-clip-text text-transparent bg-gradient-to-br from-slate-900 to-cyan-900 dark:from-slate-50 dark:to-cyan-300  pb-2.5 lg:mb-7 md:mb-5 mb-2'>
          ...
          <svg
            ...
            className='absolute md:-top-20 -top-7 lg:h-64 md:h-48 h-32 z-10 blur-2xl'
            // width='258'
            // height='293'
            viewBox='0 0 258 293'
            fill='none'
            ...
            <path
              ...
              className='fill-green-500/50 dark:fill-green-400/40'
            />
          </svg>
          <svg
            id={styles.moveUpDown100}
            className='absolute bottom-0 md:right-12 right-3 lg:h-36 md:h-20 h-14 z-10 blur-2xl'
            // width='193'
            // height='143'
            viewBox='0 0 193 143'
            fill='none'
            ...
            <path
              ...
              className='fill-purple-500/50 dark:fill-purple-400/40'
            />
          </svg>
        </div>
        <div className='bg-slate-200 dark:bg-slate-800 h-px xl:w-8/12 lg:w-full md:w-4/5 w-full'></div>
              ...
              {cards.map(card => (
                <div class='lg:w-1/3 w-full lg:mb-0 mb-6 p-4'>
                  <div class='h-full text-center flex flex-col items-center'>
                    ...
                    <h2 class='font-bold text-slate-700 dark:text-slate-200 tracking-wider text-base'>
                      {card.title}
                    </h2>
                  </div>
                </div>
