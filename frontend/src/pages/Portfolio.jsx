        ...
        <Container>
          ...
          <div className='grid lg:grid-rows-none lg:grid-cols-2 gap-5 md:min-h-screen h-full'>
            <div className='flex flex-col lg:h-4/6 h-96'>
              <div className='rounded-3xl overflow-hidden h-full bg-gray-100 cursor-pointer hover:-translate-y-3 hover:translate-x-2 transition-transform duration-150 ease-linear hover:shadow-lg'>
